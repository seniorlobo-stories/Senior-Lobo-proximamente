...
// handoff-navbar/assets/linea-runtime.js
try { (() => {
/* =========================================================================
   Línea runtime — injects the hand-drawn SVG filters and (optionally) the
   .bg stroke layer. Include ONCE per page:  <script src="linea-runtime.js">
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "handoff-navbar/assets/linea-runtime.js", error: String((e && e.message) || e) }); }

// handoff-navbar/templates/configuracion-usuario/ds-base.js
try { (() => {
...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css", "tokens/colors.css", "tokens/typography.css", "tokens/surfaces.css", "base/base.css", "components/components.css", "styles.css"]) {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "handoff-navbar/templates/configuracion-usuario/ds-base.js", error: String((e && e.message) || e) }); }

// handoff-navbar/templates/login/ds-base.js
try { (() => {
// Loads this design system into the template. In a consuming project, point
// base at the bound DS folder relative to this file (e.g. '_ds/<folder>' at
// the project root, '../_ds/<folder>' one level down) — one line to edit.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "handoff-navbar/templates/login/ds-base.js", error: String((e && e.message) || e) }); }

// handoff-navbar/templates/wizard/ds-base.js
try { (() => {
// Loads this design system into the template. In a consuming project, point
// base at the bound DS folder relative to this file (e.g. '_ds/<folder>' at
// the project root, '../_ds/<folder>' one level down) — one line to edit.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "handoff-navbar/templates/wizard/ds-base.js", error: String((e && e.message) || e) }); }
...
// uploads/Senior Lobo Design System/assets/linea-runtime.js
try { (() => {
/* =========================================================================
   Línea runtime — injects the hand-drawn SVG filters and (optionally) the
   .bg stroke layer. Include ONCE per page:  <script src="linea-runtime.js">
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "uploads/Senior Lobo Design System/assets/linea-runtime.js", error: String((e && e.message) || e) }); }

// uploads/Senior Lobo Design System/templates/configuracion-usuario/ds-base.js
try { (() => {
// Loads this design system into the template. In a consuming project, point
// base at the bound DS folder relative to this file (e.g. '_ds/<folder>' at
// the project root, '../_ds/<folder>' one level down) — one line to edit.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "uploads/Senior Lobo Design System/templates/configuracion-usuario/ds-base.js", error: String((e && e.message) || e) }); }

// uploads/Senior Lobo Design System/templates/login/ds-base.js
try { (() => {
// Loads this design system into the template. In a consuming project, point
// base at the bound DS folder relative to this file (e.g. '_ds/<folder>' at
// the project root, '../_ds/<folder>' one level down) — one line to edit.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "uploads/Senior Lobo Design System/templates/login/ds-base.js", error: String((e && e.message) || e) }); }

// uploads/Senior Lobo Design System/templates/wizard/ds-base.js
try { (() => {
// Loads this design system into the template. In a consuming project, point
// base at the bound DS folder relative to this file (e.g. '_ds/<folder>' at
// the project root, '../_ds/<folder>' one level down) — one line to edit.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "uploads/Senior Lobo Design System/templates/wizard/ds-base.js", error: String((e && e.message) || e) }); }
